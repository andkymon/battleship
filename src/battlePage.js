...
function applyHitStyling(player, gridSquare) {
    ...
    gridSquare.style.backgroundColor = player.gameboard.board[row][column] === "X" ? "blue" : "red";
}
...
document.addEventListener("computerTurn", () => {
    ...
    const humanGridSquare = document.querySelector(`.human.grid-square[data-row="${row}"][data-col="${column}"]`);
